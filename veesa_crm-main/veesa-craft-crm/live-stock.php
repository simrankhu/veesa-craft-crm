													...
													<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
														<thead>
															<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase">
															    <th class="min-w-100px">Products Name</th>
														...
														<tbody class="fw-bold text-gray-600">
															...
															<tr>
															    <td>
																	<a href="#" class="text-dark text-hover-primary">Sofa bed</a>
																</td>
																<td>
																	<a href="#" class="text-dark text-hover-primary">60 Unit</a>
																</td>
																<td>
																	<a href="#" class="text-dark text-hover-primary">10-04-2024 </a>
																</td>
																	<td>
