						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Manpower List
									<!--begin::Separator-->
											...
											<div class="card card-p-0 card-flush">
												...
												<div class="card-header align-items-center py-5 gap-2 gap-md-5">
													...
													<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
														...
														<!--<a href="#" class="btn btn-dark me-2 mb-2"><i class="las la-user fs-2 me-2"></i>Total Manpowe: 1000 </a>-->
															<?php
				                        	                    	if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
                
					                                        	?>
															<a href="add-manpower.php" class="btn btn-dark me-2 mb-2"><i class="las la-plus fs-2 me-2"></i>Add Manpower </a>
												            <?php
				                        	                    	}
				                        	                    	?>
													</div>
													...
													<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
														<thead>
															<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase">
																...
																<th class="min-w-100px">Work </th>
																<th class="min-w-100px">Place</th>
														...
														<tbody class="fw-bold text-gray-600">
															...
															<tr>
																...
																<td>
																	<a href="#" class="text-dark text-hover-primary"><?php echo $row['name'];?></a>
																</td>
																<td>
																	<a href="#" class="text-dark text-hover-primary"><?php echo $row['work'];?></a>
																</td>
																	<td>
																	<a href="#" class="text-dark text-hover-primary"><?php echo $row['place'];?></a>
																</td>
																	<td>
																	...
																	<td class="text-end">
                                                                        ...
                                                                        <a href="view_manpower.php?id=<?php echo $row['id']; ?>" title="View">
                                                                        <i class="fas fa-eye"></i>
                                                                    </a>
                                                                    <a href="add-manpower.php?id=<?php echo $row['id']; ?>" title="Edit">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                    <a href="delete_manpower.php?id=<?php echo $row['id']; ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this data?');">
