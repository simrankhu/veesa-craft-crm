...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $query = "SELECT * FROM manpower WHERE id = $id";
...
<body>
    <div class="container mt-5">
        ...
        <a href="manpower-list.php" class="btn btn-secondary">Back to Orders</a>
        <a href="add-manpower.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
    </div>
