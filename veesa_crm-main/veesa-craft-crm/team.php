                ...
                <!--header_end-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Team
									<!--begin::Separator-->
						...
						?>
														...
														<a href="add-new-team.php" class="btn btn-dark me-2 mb-2"><i class="las la-plus fs-2 me-2"></i>Add New Team</a>
												<?php
						}
						?>
													</div>
													...
													<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
														<thead>
															<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase">
																...
																<th class="min-w-100px">Team Leader</th>
																<th class="min-w-100px">TL Contact No</th>
																	<?php
						if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
						...
						?>
														...
														<tbody class="fw-bold text-gray-600">
															...
															<?php
															$i = 1;
															$sql="SELECT * FROM `manpower_team` ORDER BY `id` DESC ";
															...
															<tr>
																...
																<td>
																	<a href="#" class="text-dark text-hover-primary"><?php echo $row['team_leader_name'];?></a>
																</td>
																	<td>
																	<a href="#" class="text-dark text-hover-primary"><?php echo $row['team_contact_num'];?></a>
																</td>
																<?php
						if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
						...
						?>
        															...
        															<td class="text-end">
                                                                        ...
                                                                        <a href="view-manpower-team.php?id=<?php echo $row['id']; ?>" title="View">
                                                                        <i class="fas fa-eye"></i>
                                                                    </a>
                                                                    <a href="add-new-team.php?id=<?php echo $row['id']; ?>" title="Edit">
                                                                        <i class="fas fa-edit"></i>
                                                                    </a>
                                                                    <a href="delete-manpower-team.php?id=<?php echo $row['id']; ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this team?');">
