						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Stock List
									<!--begin::Separator-->
											...
											<div class="card card-p-0 card-flush">
												...
												<div class="card-header align-items-center py-5 gap-2 gap-md-5">
													...
													<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
														...
														<a href="stock-list-add.php" class="btn btn-dark me-2 mb-2"><i class="las la-plus fs-2 me-2"></i>Add Stock</a>
													...
													<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
														<thead>
															<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase">
																<th class="min-w-100px">Stock Name</th>
																<th class="min-w-100px">Available Stock</th>
														...
														<tbody class="fw-bold text-gray-600">
															...
															<a href="stock-list-edit.php" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
